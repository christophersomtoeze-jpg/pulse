...
export function PlanGate({ plan, feature, title, description, onBilling }: {
  ...
  const currentPlanLabel = plan === 'business' ? 'Business' : plan === 'pro' ? 'Pro' : plan === 'starter' ? 'Starter' : 'Free';
  return (
    <div className="mx-auto max-w-xl px-4 pb-28 pt-12">
      <div className="glass-strong rounded-3xl p-6 text-center">
        ...
        <p className="mt-4 text-[10px] font-semibold uppercase tracking-[.2em] text-pulse-300">{label} feature · current plan {currentPlanLabel}</p>
