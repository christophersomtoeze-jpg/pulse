...
## Pricing Catalog
- Free: $0/month
- Pro: $39/month per workspace
- Business: $99/month per workspace
- Enterprise: custom pricing

The UI displays these public prices. Stripe Price IDs must point to matching Stripe recurring prices before live payments are enabled.
